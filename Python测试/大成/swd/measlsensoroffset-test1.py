...
# valid = False
    ...
    for i in range(len(list1)):
        if list1[i][2] == 1:
            vaild, lenth_tem = findnearpointA.findpoint(True, False, list1[i][3] * 0.025, 0, 1500, 9236)
        elif list1[i][2] == 2:
            vaild, lenth_tem = findnearpointA.findpoint(False, True, 0, list1[i][3] * 0.025, 1500, 9236)
            findnearpointB.findpoint(True, False, list1[i][3] * 0.025, 0, 1500, 59108)
            if vaild:
                lenthA.append(lenth_tem)
        elif list1[i][2] == 3:
            vaild, lenth_tem = findnearpointB.findpoint(False, True, 0, list1[i][3] * 0.025, 1500, 59108)
            findnearpointC.findpoint(True, False, list1[i][3] * 0.025, 0, 1500, 12589)
            if vaild:
                lenthB.append(lenth_tem)
        elif list1[i][2] == 4:
            vaild, lenth_tem = findnearpointC.findpoint(False, True, 0, list1[i][3] * 0.025, 1500, 12589)
            findnearpointD.findpoint(True, False, list1[i][3] * 0.025, 0, 1500, 69615)
            if vaild:
                lenthC.append(lenth_tem)
        elif list1[i][2] == 5:
            vaild, lenth_tem = findnearpointD.findpoint(False, True, 0, list1[i][3] * 0.025, 1500, 69615)
            if vaild:
