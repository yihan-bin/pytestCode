...
class PLC(object):
    ...
    def _read_tag(self, tag_name, elements, data_type):
        ...
        resp = self._initial_read(tag, base_tag, data_type,elements)
    ...
    def _build_ioi(self, tag_name, data_type,elements=1):
        """
    ...
    def _add_write_service(self, ioi, write_data, data_type):
        ...
        return write_service#+b'\x01\x00\x01\x00'
    ...
    def _initial_read(self, tag, base_tag, data_type,elements=1):
        """
        ...
        ioi = self._build_ioi(base_tag, data_type,elements)
